      ...
      <div className="w-full max-w-2xl bg-white dark:bg-slate-800 rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-200 dark:border-slate-700 overflow-hidden">
        ...
        <div className="p-8 border-b border-slate-200 dark:border-slate-700 bg-gradient-to-r from-blue-600 to-indigo-600">
          ...
          <p className="mt-2 text-blue-100">
            One last step — let's set up your profile to get started.
          </p>
        </div>
        ...
        <form onSubmit={handleComplete} className="p-8 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                },
                {
                  id: "business",
                  title: "Business",
                  desc: "Company tracking",
                  emoji: "💼",
                },
                {
                  id: "friends",
                  title: "Friends/Family",
                  desc: "Shared expenses",
                  emoji: "👨‍👩‍👧",
                },
              ].map((type) => (
                <div
                ...
                >
                  <div className="flex justify-between items-start mb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        className={`font-semibold ${profileType === type.id ? "text-blue-700 dark:text-blue-400" : "text-slate-900 dark:text-white"}`}
                      >
                        {type.title}
                      </span>
                    </div>
                  ...
                  <p
                    className={`text-sm ${profileType === type.id ? "text-blue-600/80 dark:text-blue-400/80" : "text-slate-500 dark:text-slate-400"}`}
                  >
                    {type.desc}
                  </p>
                </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none transition-all"
            >
              <option value="USD" className="bg-white dark:bg-slate-800">
                USD ($) — US Dollar
              </option>
              <option value="EUR" className="bg-white dark:bg-slate-800">
                EUR (€) — Euro
              </option>
              <option value="GBP" className="bg-white dark:bg-slate-800">
                GBP (£) — British Pound
              </option>
              <option value="INR" className="bg-white dark:bg-slate-800">
                INR (₹) — Indian Rupee
              </option>
              <option value="AUD" className="bg-white dark:bg-slate-800">
                AUD ($) — Australian Dollar
              </option>
              <option value="CAD" className="bg-white dark:bg-slate-800">
                CAD ($) — Canadian Dollar
              </option>
            </select>
          </div>
